...
{
    /// <summary>
    /// Extensions for <see cref="IEventAggregator2"/>.
    /// </summary>
    public static class EventAggregatorExtensions
    {
        ...
        /// <param name="eventAggregator"></param>
        /// <param name = "subscriber">The instance to subscribe for event publication.</param>
        public static void SubscribeOnUIThread(this IEventAggregator2 eventAggregator, object subscriber)
        {
        ...
        public static Task PublishOnCurrentThreadAsync(this IEventAggregator2 eventAggregator, object message, CancellationToken cancellationToken)
        {
        ...
        /// <param name = "message">The message instance.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static Task PublishOnCurrentThreadAsync(this IEventAggregator2 eventAggregator, object message)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static Task PublishOnBackgroundThreadAsync(this IEventAggregator2 eventAggregator, object message, CancellationToken cancellationToken)
        {
        ...
        /// <param name = "message">The message instance.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static Task PublishOnBackgroundThreadAsync(this IEventAggregator2 eventAggregator, object message)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static Task PublishOnUIThreadAsync(this IEventAggregator2 eventAggregator, object message, CancellationToken cancellationToken)
        {
        ...
        /// <param name = "message">The message instance.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static Task PublishOnUIThreadAsync(this IEventAggregator2 eventAggregator, object message)
        {
